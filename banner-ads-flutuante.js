...
// Cria e insere o elemento do banner automaticamente
const footerBannerDiv = document.createElement('div');
footerBannerDiv.id = 'ads-banner';
document.body.appendChild(footerBannerDiv);
...
function mostrarBannerAleatorio() {
    ...
    const footerBannerDiv = document.getElementById('ads-banner');
